...
LicSliderGroup::LicSliderGroup(QWidget * parent):QWidget(parent)
{
...
// 	QLabel* label3 = new QLabel("Alpha correction adjustment");
	QLabel* label = new QLabel("Lic Map Positions");
...
QSlider* LicSliderGroup::getDetail()
{
	return detail;
}

QSlider* LicSliderGroup::getAlpha()
{
	return alpha;
}


void LicSliderGroup::setSlicesMapList(ColorMap* cmaplistin)
{
	cmaplist = cmaplistin;
...
void LicSliderGroup::addSliceNode()
{
	addSlicesMap(0,0,1,1,1);
}

void LicSliderGroup::addSlicesMap(int x, int y, int z, int alpha, int value)
{
