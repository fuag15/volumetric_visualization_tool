...
SlicesControllerSliderGroup::SlicesControllerSliderGroup(QWidget * parent):QWidget(parent)
{
	...
	QLabel* label = new QLabel("Slices Map Positions");
...
QSlider* SlicesControllerSliderGroup::getDetail()
{
	return detail;
}

QSlider* SlicesControllerSliderGroup::getAlpha()
{
	return alpha;
}


void SlicesControllerSliderGroup::setSlicesMapList(ColorMap* cmaplistin)
{
	cmaplist = cmaplistin;
...
void SlicesControllerSliderGroup::addSliceNode()
{
	addSlicesMap(0,0,1,1,1);
}

void SlicesControllerSliderGroup::addSlicesMap(int x, int y, int z, int alpha, int value)
{
